...
שירותים: ההחלקה הבריאה בעולם (חידוש שורשים 850₪, מלאה מ-1000₪) — שם השיטה OXO Organic, אך אל תזכירי שם זה אלא אם הלקוחה שואלת ישירות. תוספות שיער (קראטין 22₪/גרם, צמידים 2500₪/100גרם), צבע והייליטס.
...
1️⃣ ההחלקה הבריאה בעולם 💎
2️⃣ תוספות שיער
3️⃣ צבע והייליטס
4️⃣ קטלוג שירותים ומחירים
5️⃣ חזרה לתפריט ראשי`;

const STRAIGHTENING_MENU = `💆‍♀️ *ההחלקה הבריאה בעולם — Juliet Beauty* 💎
...
const STRAIGHTENING_ANSWERS = {
  '1': `💆‍♀️ *ההחלקה הבריאה בעולם — בשיטת ג'ולייט* 💎

היי! אני יוליה — מאסטרית שיער עם ניסיון של *12 שנים* בהחלקות מקצועיות 🙏

השיטה שאני עובדת בה היא *ההחלקה הבריאה והמשקמת ביותר הקיימת בעולם* —
טכניקה ייחודית שמשנה את *מבנה השיער לצמיתות*, בצורה הבטוחה ביותר שיש!

🔬 *מה הופך אותה למיוחדת?*
החומר נחפף ב-*100% מהשיער עם שמפו* לפני תחילת הטיפול —
זה מה שמבדיל אותה מכל החלקה אחרת בשוק!
כך אין עשן, אין אדים מסוכנים, ואין נזק לשיער.

✅ *מאושרת FDA, האיגוד האירופאי ומשרד הבריאות*
✅ *ללא פורמלין* — בריאה לחלוטין!
✅ *לא נמרחת על הקרקפת* — לא גורמת לנשירה ושבירה
✅ *מחליקה לצמיתות* — מה שהוחלק נשאר חלק לתמיד
✅ *טבעונית לחלוטין* — ללא רכיבים מהחי
✅ *אחריות מלאה* על תוצאות הטיפול

🔄 *חידוש שורשים בלבד* — כל *6-8 חודשים*
_(משלמת פעם אחת על ההחלקה המלאה, ואחר כך רק על השורשים)_

📸 רוצה לראות תוצאות אמיתיות?
👇 @juliet_beauty_boutique`,

  '2': `✨ *למה השיטה שלי שונה מכל החלקה אחרת?* 💎

אחרי הטיפול — *אפס הגבלות!* 🙌

🏊‍♀️ *ים ובריכה חופשי* — כבר באותו יום! בלי להתחשב בכלום
🧴 *כל שמפו* — *לא צריך* שמפו ללא מלחים או ללא סולפט
🎨 *צביעה מיד* — ניתן לצבוע ישירות בסיום הטיפול
💨 *שיער שמתייבש לבד חלק* — אחרי מקלחת רק להסתרק, בלי פן
🤰 *מתאים לנשים בהריון, מניקות וילדות* — בטוח לחלוטין!
🌿 *טבעוני לחלוטין* — ללא רכיבים מהחי

🔬 *מה הסוד?*
הנוסחה מחלישה ומרחיבה את קשרי הגופרית בשיער בצורה עדינה —
*מבלי למוסס אותם*. השיער לא נפגם בתהליך!
בסיום — שיער חלק, בריא, מבריק ורך לגמרי 💎

🎯 *מתאימה לכל סוגי השיער:*
שיער טבעי | צבוע | פגום | בלונדיני | עם גוונים | שיער מרדני ביותר

💎 בקיצור — שיער חלק ובריא, בלי להוותר על כלום!`,

  '3': `❓ *שאלות נפוצות — ההחלקה בשיטת ג'ולייט* 💎

*ש: כמה זמן מחזיק הטיפול?*
✅ לצמיתות! מה שהוחלק — נשאר חלק לתמיד
מחדשים רק את השורשים החדשים שצומחים, כל *6-8 חודשים*

*ש: צריך שמפו מיוחד אחרי?*
✅ לא! כל שמפו רגיל — *לא צריך* שמפו ללא מלחים או ללא סולפט

*ש: מתי אפשר לשחות?*
✅ *כבר באותו יום!* ים, בריכה, ג'קוזי — הכל חופשי לחלוטין

*ש: מתי אפשר לצבוע?*
✅ ישר בסיום הטיפול — ללא המתנה בכלל

*ש: האם מתאים לשיער צבוע / פגום / בלונדיני?*
✅ כן! הטיפול משקם את השיער ולא פוגם בו

*ש: האם נשים בהריון, מניקות וילדות יכולות?*
✅ כן! הטיפול בטוח לחלוטין — מאושר משרד הבריאות

*ש: האם גורם לנשירת שיער?*
✅ לא! החומר לא נמרח ישירות על הקרקפת

*ש: מה שם החומר / השיטה?*
✍️ כתבי לי *"שם ההחלקה"* ואספר לך 😊

📸 שאלה נוספת? שלחי הודעה ויוליה תענה אישית 💎`,

  '4': `💰 *מחירי ההחלקה — Juliet Beauty* 💎
...
3️⃣ האם צריך שמפו מיוחד אחרי ההחלקה?
...
💆‍♀️ *ההחלקה הבריאה בעולם* — ללא פורמלין
   בשיטה הייחודית של ג'ולייט 💎
...
כלומר: משלמת פעם אחת על ההחלקה המלאה, ואחר כך רק על השורשים 😊`,
  ...
  '3': `🧴 *שמפו אחרי ההחלקה — האמת:*

❌ *לא צריך* שמפו ללא מלחים או ללא סולפט!

✅ כל שמפו רגיל — אין שום הגבלה
✅ אפשר לשחות בים ובריכה כבר באותו יום
✅ אפשר לצבוע ישר בסיום הטיפול
✅ מתאים לנשים בהריון, מניקות וילדות

זה אחד היתרונות הגדולים של השיטה שלי 💎`,
...
client.on('message', async (message) => {
  ...
  // ── שם ההחלקה — רק אם שואלים ישירות ────────
  const asksProductName = ['שם ההחלקה','שם החומר','שם המוצר','מה החומר','מה השיטה','oxo','אוקסו','oxo organic'].some(k => bodyLower.includes(k));
  if (asksProductName) {
    await message.reply(
      `💆‍♀️ *שם השיטה שאני עובדת בה:*\n\n` +
      `*OXO Organic* — ההחלקה הבריאה בעולם 💎\n\n` +
      `זו שיטה ייחודית שמחלישה את קשרי הגופרית בשיער בצורה עדינה ובטוחה, ללא פורמלין, ומאושרת FDA + משרד הבריאות.\n\n` +
      `📖 מידע נוסף על החומר: https://oxoorganic.co.il\n\n` +
      `💎 _ג'ולייט היא מורשית עבודה עם OXO Organic_`
    );
    return;
  }
